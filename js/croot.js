...
async function fetchRoads(longitude, latitude, maxDistance) {
  try {
    const response = await fetch("https://asia-southeast2-awangga.cloudfunctions.net/satsetin/geo/roads", {
      method: "POST",
      headers: {
...
async function fetchRegionGeoJSON(longitude, latitude) {
  try {
    const response = await fetch("https://asia-southeast2-awangga.cloudfunctions.net/satsetin/geo/region", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
